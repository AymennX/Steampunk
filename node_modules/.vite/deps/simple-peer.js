import {
  require_browser
} from "./chunk-P37KE666.js";
import {
  buffer_exports,
  init_buffer
} from "./chunk-YLMCWQJD.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_safe_buffer = __commonJS({
  "node_modules/safe-buffer/index.js"(exports, module) {
    ...
    function SafeBuffer(arg, encodingOrOffset, length2) {
      return Buffer(arg, encodingOrOffset, length2);
    }
...
var avoid_parse_require2, _M_2, _errnoException, _exceptionWithHostPort, _extend, callbackify, debug, debuglog, deprecate, format, styleText, formatWithOptions, getCallSite, getCallSites, getSystemErrorMap, getSystemErrorName, getSystemErrorMessage, inherits, inspect, isArray, isBoolean, isBuffer, isDeepStrictEqual, isNull, isNullOrUndefined, isNumber, isString, isSymbol, isUndefined, isRegExp, isObject, isDate, isError, isFunction, isPrimitive, log, promisify, stripVTControlCharacters, toUSVString, transferableAbortSignal, transferableAbortController, aborted, types, parseEnv, parseArgs, TextDecoder, TextEncoder, MIMEType, MIMEParams, diff, keyword_default2;
var init_util = __esm({
  "node_modules/.vite-electron-renderer/util.mjs"() {
    avoid_parse_require2 = __require;
    _M_2 = avoid_parse_require2("util");
    _errnoException = _M_2._errnoException;
    _exceptionWithHostPort = _M_2._exceptionWithHostPort;
    _extend = _M_2._extend;
    callbackify = _M_2.callbackify;
    debug = _M_2.debug;
    debuglog = _M_2.debuglog;
    deprecate = _M_2.deprecate;
    format = _M_2.format;
    styleText = _M_2.styleText;
    formatWithOptions = _M_2.formatWithOptions;
    getCallSite = _M_2.getCallSite;
    getCallSites = _M_2.getCallSites;
    getSystemErrorMap = _M_2.getSystemErrorMap;
    getSystemErrorName = _M_2.getSystemErrorName;
    getSystemErrorMessage = _M_2.getSystemErrorMessage;
    inherits = _M_2.inherits;
    inspect = _M_2.inspect;
    isArray = _M_2.isArray;
    isBoolean = _M_2.isBoolean;
    isBuffer = _M_2.isBuffer;
    isDeepStrictEqual = _M_2.isDeepStrictEqual;
    isNull = _M_2.isNull;
    isNullOrUndefined = _M_2.isNullOrUndefined;
    isNumber = _M_2.isNumber;
    isString = _M_2.isString;
    isSymbol = _M_2.isSymbol;
    isUndefined = _M_2.isUndefined;
    isRegExp = _M_2.isRegExp;
    isObject = _M_2.isObject;
    isDate = _M_2.isDate;
    isError = _M_2.isError;
    isFunction = _M_2.isFunction;
    isPrimitive = _M_2.isPrimitive;
    log = _M_2.log;
    promisify = _M_2.promisify;
    stripVTControlCharacters = _M_2.stripVTControlCharacters;
    toUSVString = _M_2.toUSVString;
    transferableAbortSignal = _M_2.transferableAbortSignal;
    transferableAbortController = _M_2.transferableAbortController;
    aborted = _M_2.aborted;
    types = _M_2.types;
    parseEnv = _M_2.parseEnv;
    parseArgs = _M_2.parseArgs;
    TextDecoder = _M_2.TextDecoder;
    TextEncoder = _M_2.TextEncoder;
    MIMEType = _M_2.MIMEType;
    MIMEParams = _M_2.MIMEParams;
    diff = _M_2.diff;
...
var require_stream_writable = __commonJS({
  "node_modules/readable-stream/lib/_stream_writable.js"(exports, module) {
    ...
    var Buffer = (init_buffer(), __toCommonJS(buffer_exports)).Buffer;
...
var require_err_code = __commonJS({
  "node_modules/simple-peer/node_modules/err-code/index.js"(exports, module) {
    "use strict";
...
var require_simple_peer = __commonJS({
  "node_modules/simple-peer/index.js"(exports, module) {
    var debug2 = require_browser()("simple-peer");
