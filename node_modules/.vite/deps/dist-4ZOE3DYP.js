...
import {
  CapLevelController,
  Hls
} from "./chunk-SX2LBVGB.js";
import {
  CustomVideoElement,
  MediaTracksMixin
} from "./chunk-R6KAR6XW.js";
import {
  require_react
} from "./chunk-2DWYVZJG.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
var na = function(r13, e, t4, i2) {
  if (e && typeof e == "object" || typeof e == "function")
    for (var a3 = ra(e), n2 = 0, o4 = a3.length, s4; n2 < o4; n2++)
      s4 = a3[n2], !ia.call(r13, s4) && s4 !== t4 && _t(r13, s4, { get: (function(u5) {
        return e[u5];
...
var wr = B(function(Hs, Tr) {
  ...
  function ja(r13) {
    ...
    for (var i2 in e)
      t4.push({ name: "data-" + i2, value: e[i2] });
  ...
  function Wa(r13) {
    var e = [];
    for (var t4 in r13)
      Fa(r13, t4) && e.push({ name: t4, value: r13[t4] });
    for (var i2 in r13._attributes)
      for (var a3 in r13._attributes[i2]) {
...
var rt = B(function(Us, Er) {
  ...
  L4.prototype.setAttributeNS = function(e, t4, i2) {
    ...
    if (o4 > -1 && (a3 = t4.substr(0, o4), n2 = t4.substr(o4 + 1)), this.tagName === "INPUT" && t4 === "type")
      this.type = i2;
    else {
...
function Ee(r13, e) {
  ...
  for (var t4 = 0, i2 = new Array(e); t4 < e; t4++)
    i2[t4] = r13[t4];
  return i2;
}
function Pe(r13, e) {
  if (r13) {
    ...
    if (t4 === "Object" && r13.constructor && (t4 = r13.constructor.name), t4 === "Map" || t4 === "Set")
      return Array.from(t4);
    if (t4 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t4))
      return Ee(r13, e);
  }
}
function H(r13, e) {
...
function bt(r13) {
  if (typeof Symbol != "undefined" && r13[Symbol.iterator] != null || r13["@@iterator"] != null)
    return Array.from(r13);
}
function Tt() {
...
var wt = function(r13) {
  ...
  return { trace: function() {
    for (var T4 = arguments.length, x7 = new Array(T4), v3 = 0; v3 < T4; v3++)
      x7[v3] = arguments[v3];
    if (!(c4 > Y.TRACE))
      return u5.apply(void 0, V(x7));
  }, debug: function() {
    for (var T4 = arguments.length, x7 = new Array(T4), v3 = 0; v3 < T4; v3++)
      x7[v3] = arguments[v3];
    if (!(c4 > Y.DEBUG))
      return h4.apply(void 0, V(x7));
  }, info: function() {
    for (var T4 = arguments.length, x7 = new Array(T4), v3 = 0; v3 < T4; v3++)
      x7[v3] = arguments[v3];
    if (!(c4 > Y.INFO))
      return f5.apply(void 0, V(x7));
  }, warn: function() {
    for (var T4 = arguments.length, x7 = new Array(T4), v3 = 0; v3 < T4; v3++)
      x7[v3] = arguments[v3];
    if (!(c4 > Y.WARN))
      return E6.apply(void 0, V(x7));
  }, error: function() {
    for (var T4 = arguments.length, x7 = new Array(T4), v3 = 0; v3 < T4; v3++)
      x7[v3] = arguments[v3];
    if (!(c4 > Y.ERROR))
      return y5.apply(void 0, V(x7));
  }, get level() {
    return c4;
  }, set level(p6) {
...
function St(r13, e) {
  ...
  for (n2 = 0; n2 < i2.length; n2++)
    a3 = i2[n2], !(e.indexOf(a3) >= 0) && (t4[a3] = r13[a3]);
  return t4;
}
function Dt(r13, e) {
  if (r13 == null)
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (a3 = 0; a3 < n2.length; a3++)
      i2 = n2[a3], !(e.indexOf(i2) >= 0) && Object.prototype.propertyIsEnumerable.call(r13, i2) && (t4[i2] = r13[i2]);
  }
  return t4;
}
function Rt() {
...
var De = function(r13) {
  if (!(!r13 || typeof r13.getAllResponseHeaders != "function"))
    return pe(r13.getAllResponseHeaders());
};
...
var Nt = function(r13, e, t4) {
  ...
  var u5 = {}, f5 = function(_2) {
    if (typeof _2.getRequests != "function")
      return null;
  ...
  var p6 = { video: void 0, audio: void 0, totalBitrate: void 0 }, T4 = function() {
    if (p6.video && typeof p6.video.bitrate == "number") {
      ...
      if (p6.audio && typeof p6.audio.bitrate == "number" && (_2 += p6.audio.bitrate), _2 !== p6.totalBitrate)
        return p6.totalBitrate = _2, { video_source_bitrate: _2, video_source_height: p6.video.height, video_source_width: p6.video.width, video_source_codec: fa(p6.video.codec) };
    }
...
var ba = function() {
  ...
  return N(r13, [{ key: "_updateMaxPlayheadPosition", value: function() {
    ...
    if (i2 && i2.player_playhead_time)
      this.pm.data.player_playhead_time = i2.player_playhead_time, n2(), this._updateMaxPlayheadPosition();
...
var Ra = function() {
  ...
  return N(r13, [{ key: "inPrerollPosition", value: function() {
    ...
    for (var i2 = 0; i2 < this._adRequests.length; i2++)
      if (this._adRequests[i2].ad_request_id === t4)
      ...
      if (typeof document != "undefined") {
        ...
        for (var f5 = document.cookie ? document.cookie.split("; ") : [], h4 = /(%[0-9A-Z]{2})+/g, E6 = 0; E6 < f5.length; E6++) {
          ...
          try {
            ...
            if (c4 = t4.read ? t4.read(c4, p6) : t4(c4, p6) || c4.replace(h4, decodeURIComponent), this.json)
              try {
                c4 = JSON.parse(c4);
              } catch (T4) {
              }
...
function lr(r13) {
  var e = {};
  for (var t4 in r13)
    r13.hasOwnProperty(t4) && (e[r13[t4]] = t4);
  return e;
}
function me(r13) {
  var e = {}, t4 = {};
  ...
  return N(r13, [{ key: "send", value: function(t4, i2) {
    if (!(!t4 || !(i2 != null && i2.view_id))) {
      if (this.respectDoNotTrack && ce())
        return q.info("Not sending `" + t4 + "` because Do Not Track is enabled");
      ...
      if (this.lastEventTime = this.mux.utils.now(), s4)
        return q.info("Not sending event due to sample rate restriction", t4, n2, f5);
      if (this.envKey || q.info("Missing environment key (envKey) - beacons will be dropped if the video source is not a valid mux video URL", t4, n2, f5), !this.rateLimited)
        if (q.info("Sending event", t4, n2, f5), this.rateLimited = !this.eventQueue.queueEvent(t4, f5), this.mux.WINDOW_UNLOADING && t4 === "viewend")
          this.eventQueue.destroy(true);
        else {
          if (this.mux.WINDOW_HIDDEN && t4 === "hb")
            this.eventQueue.flushEvents(true);
          else if (pi.indexOf(t4) >= 0) {
            if (t4 === "error" && i2.player_error_severity === "warning")
              return;
            this.eventQueue.flushEvents();
          }
          if (this.rateLimited)
            return n2.event = "eventrateexceeded", f5 = me(n2), this.eventQueue.queueEvent(n2.event, f5), q.error("Beaconing disabled due to rate limit.");
        }
    }
    ...
    if (o4 === "-1" || t4 === "viewstart" || t4 === "viewend" || !this.previousBeaconData || this.mux.utils.now() - this.lastEventTime >= mi)
      n2 = ue({}, i2), o4 && (this.previousBeaconData = n2), o4 && t4 === "viewend" && (this.previousBeaconData = null);
    else {
...
var Di = function(r13) {
  ...
  function t4(i2, a3, n2) {
    ...
    var s4 = { debug: false, minimumRebufferDuration: 250, sustainedRebufferThreshold: 1e3, playbackHeartbeatTime: 25, beaconDomain: "litix.io", sampleRate: 1, disableCookies: false, respectDoNotTrack: false, disableRebufferTracking: false, disablePlayheadRebufferTracking: false, disableAdPlaybackRangeFiltering: false, errorTranslator: function(y5) {
      ...
      for (var y5 = arguments.length, c4 = new Array(y5), p6 = 0; p6 < y5; p6++)
        c4[p6] = arguments[p6];
      return c4;
...
function ot(r13, e, t4) {
  ...
  if (a3) {
    if (o4 !== "video" && o4 !== "audio")
      return s4.error("The element of `" + n2 + "` was not a media element.");
  } else
    return s4.error("No element was found with the `" + n2 + "` query selector.");
  ...
  a3.mux.destroy = function() {
    ...
    if (T4) {
      if (v3 !== "video" && v3 !== "audio")
        return r13.log.error("The element of `" + x7 + "` was not a media element.");
    } else
      return r13.log.error("No element was found with the `" + x7 + "` query selector.");
    ...
    if (c4 && (p6 === a3 || p6 != null && p6.contains(a3)))
      r13.emit(n2, "playbackmodechange", { player_playback_mode: "fullscreen", player_playback_mode_data: "{}" });
    else if (!c4) {
...
function ut(r13, e) {
  if (!r13 || !e || !ge.default || typeof ge.default.getComputedStyle != "function")
    return "";
  var t4;
...
var ct = function(r13) {
  if (r13.toLowerCase() === "yes" || r13.toLowerCase() === "no")
    return r13.toLowerCase() === "yes";
...
var Ii = function(r13) {
  ...
  if (r13) {
    ...
    return n2.forEach(function(o4, s4) {
      for (var u5 = o4.replace(/['"]+/g, "").split("="), f5 = 0; f5 < u5.length; f5++)
        u5[f5] === "DATA-ID" && (e["DATA-ID"] = u5[1 - f5]), u5[f5] === "VALUE" && (e.VALUE = u5[1 - f5]);
    }), { data: e };
  }
};
var Qr = Ve;
...
function me2(e, t4, r13) {
  ...
  for (let n2 = 0; n2 < e.length; n2++)
    if (e.start(n2) <= r13 && e.end(n2) >= r13)
      return true;
  return false;
}
var B2 = (e) => {
...
function ve(e, t4) {
  ...
  t4.on(E.Events.MANIFEST_PARSED, function(c4, d4) {
    ...
    for (let m6 of e.videoRenditions)
      m6.id && !u5.includes(m6.id) && l3.removeRendition(m6);
  });
  let n2 = (c4) => {
  ...
  let o4 = () => {
    for (let c4 of e.videoTracks)
      e.removeVideoTrack(c4);
  }, s4 = () => {
    for (let c4 of e.audioTracks)
      e.removeAudioTrack(c4);
  }, a3 = () => {
    o4(), s4();
  };
...
async function he2(e, t4, r13, n2) {
  ...
  return o4 || (o4 = ae(e, n2, r13), o4.mode = "hidden", await new Promise((s4) => setTimeout(() => s4(void 0), 0))), o4.mode !== "hidden" && (o4.mode = "hidden"), [...t4].sort((s4, a3) => oe(a3) - oe(s4)).forEach((s4) => {
    ...
    if ("endTime" in s4 && s4.endTime != null)
      o4 == null || o4.addCue(new VTTCue(i2, s4.endTime, n2 === "chapters" ? a3 : JSON.stringify(a3 != null ? a3 : null)));
    else {
...
function Le2(e, t4 = { label: se2 }) {
  var s4, a3;
  let r13 = O(e, t4.label, "metadata");
  if (!((s4 = r13 == null ? void 0 : r13.activeCues) != null && s4.length))
    return;
  if (r13.activeCues.length === 1)
    return J2(r13.activeCues[0]);
...
function ft2(e, t4) {
  if (t4 && t4.playingDate)
    return t4.playingDate;
...
var N2 = class N3 extends Oe2 {
  ...
  getMaxLevel(t4) {
    if (this.getMaxAutoResolution() !== void 0)
      return this.getMaxLevelCapped(t4);
...
var vt2 = async (e, t4) => {
  if (t4 === S2.MP4)
    return { streamType: h.ON_DEMAND, targetLiveWindow: Number.NaN, liveEdgeStartOffset: void 0, sessionData: void 0 };
  if (t4 === S2.M3U8) {
    let r13 = await fetch(e);
    if (!r13.ok)
      return Promise.reject(r13);
...
var pe2 = async (e, t4) => {
  ...
  try {
    ...
    if (!((r13 = s4 == null ? void 0 : s4[0]) != null && r13.metadata))
      return;
    for (let c4 of s4[0].metadata)
      c4.key && c4.value && (a3[c4.key] = c4.value);
...
var Ge = (e, t4) => {
  ...
  if (!(n2 != null && n2.length))
    return;
  if (e.currentTime < e.duration - (r13.targetduration + 0.5))
    return false;
  let o4 = n2[n2.length - 1];
  if (e.currentTime <= o4.start)
    return false;
...
var zt2 = (e, t4, r13) => {
  ...
  if (v(t4, "durationchange", d4), t4 && n2) {
    ...
    if (typeof o4 == "string") {
      ...
      let m6 = () => {
        if (He2(t4) !== h.LIVE || Number.isFinite(t4.duration))
          return;
    ...
    r13 && o4 ? (r13.once(E.Events.LEVEL_LOADED, (y5, m6) => {
...
async function tt(e) {
  ...
  if (t4.src && (n2 !== T.MEDIA_ERR_DECODE || n2 !== void 0))
    try {
...
var qt2 = (e, t4) => {
  ...
  let n2 = { [E.ErrorTypes.NETWORK_ERROR]: T.MEDIA_ERR_NETWORK, [E.ErrorTypes.MEDIA_ERROR]: T.MEDIA_ERR_DECODE, [E.ErrorTypes.KEY_SYSTEM_ERROR]: T.MEDIA_ERR_ENCRYPTED }, o4 = (u5) => [E.ErrorDetails.KEY_SYSTEM_LICENSE_REQUEST_FAILED, E.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_REQUEST_FAILED].includes(u5.details) ? T.MEDIA_ERR_NETWORK : n2[u5.type], s4 = (u5) => {
    if (u5.type === E.ErrorTypes.KEY_SYSTEM_ERROR)
      return D.DRM;
    if (u5.type === E.ErrorTypes.NETWORK_ERROR)
      return D.VIDEO;
  }, a3, i2 = o4(e);
  if (i2 === T.MEDIA_ERR_NETWORK && e.response) {
  ...
  } else if (i2 === T.MEDIA_ERR_ENCRYPTED)
    if (e.details === E.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE) {
      ...
      a3 = new T(e.error.message, T.MEDIA_ERR_ENCRYPTED, e.fatal), a3.errorCategory = D.DRM, a3.muxCode = b2.ENCRYPTED_ERROR;
  else
    a3 = new T("", i2, e.fatal);
...
var B3 = class extends CustomVideoElement {
  ...
  get playbackToken() {
    var e, i2, r13, l3;
    if (this.hasAttribute(t.PLAYBACK_TOKEN))
      return (e = this.getAttribute(t.PLAYBACK_TOKEN)) != null ? e : void 0;
    ...
    if (this.src)
      return (l3 = new URLSearchParams(this.src).get("token")) != null ? l3 : void 0;
  }
  set playbackToken(e) {
  ...
  get liveEdgeOffset() {
    if (this.hasAttribute(t.LIVE_EDGE_OFFSET))
      return +this.getAttribute(t.LIVE_EDGE_OFFSET);
  }
...
var st3 = (t4, { token: a3, customDomain: e = nt3, thumbnailTime: i2, programTime: r13 } = {}) => {
  ...
  if (!(a3 && d4 !== "t"))
    return `https://image.${e}/${t4}/thumbnail.webp${ye2({ token: a3, time: n2, program_time: r13 })}`;
};
var dt3 = (t4, { token: a3, customDomain: e = nt3, programStartTime: i2, programEndTime: r13 } = {}) => {
  var d4;
  let { aud: n2 } = (d4 = re2(a3)) != null ? d4 : {};
  if (!(a3 && n2 !== "s"))
    return `https://image.${e}/${t4}/storyboard.vtt${ye2({ token: a3, format: "webp", program_start_time: i2, program_end_time: r13 })}`;
};
var z2 = (t4) => {
  if (t4) {
    if ([h.LIVE, h.ON_DEMAND].includes(t4))
      return t4;
    if (t4 != null && t4.includes("live"))
      return h.LIVE;
  }
};
...
var de3 = class {
  ...
  get template() {
    if (ke2.has(this.stringsKey))
      return ke2.get(this.stringsKey);
    {
...
var ca2 = (t4, a3 = false) => {
  ...
  if (t4.muxCode) {
    ...
    if (t4.muxCode === b2.NETWORK_OFFLINE)
      return x("Your device appears to be offline", a3);
    if (t4.muxCode === b2.NETWORK_TOKEN_EXPIRED)
      return x("{category} URL has expired", a3).format({ category: r13 });
    if ([b2.NETWORK_TOKEN_SUB_MISMATCH, b2.NETWORK_TOKEN_AUD_MISMATCH, b2.NETWORK_TOKEN_AUD_MISSING, b2.NETWORK_TOKEN_MALFORMED].includes(t4.muxCode))
      return x("{category} URL is formatted incorrectly", a3).format({ category: r13 });
    if (t4.muxCode === b2.NETWORK_TOKEN_MISSING)
      return x("Invalid {categoryName} URL", a3).format({ categoryName: n2 });
    if (t4.muxCode === b2.NETWORK_NOT_FOUND)
      return x("{category} does not exist", a3).format({ category: r13 });
  ...
  if (t4.code) {
    if (t4.code === T.MEDIA_ERR_NETWORK)
      return x("Network Error", a3);
    if (t4.code === T.MEDIA_ERR_DECODE)
      return x("Media Error", a3);
    if (t4.code === T.MEDIA_ERR_SRC_NOT_SUPPORTED)
...
var ba2 = (t4) => {
  if (t4.muxCode) {
    ...
    if (t4.muxCode === b2.NETWORK_TOKEN_MALFORMED)
      return "403-malformatted-token.md";
    if ([b2.NETWORK_TOKEN_AUD_MISMATCH, b2.NETWORK_TOKEN_AUD_MISSING].includes(t4.muxCode))
      return "403-incorrect-aud-value.md";
    if (t4.muxCode === b2.NETWORK_TOKEN_SUB_MISMATCH)
...
var Ne3 = class extends Ce3 {
  constructor() {
    ...
    v2(this, K3, { ...Nt3, onCloseErrorDialog: (e) => {
      ...
      var n2;
      if (((n2 = e.composedPath()[0]) == null ? void 0 : n2.localName) !== "media-error-dialog")
        return;
  ...
  async requestFullscreen(e) {
    ...
    if (!(!this.mediaController || this.mediaController.hasAttribute(MediaUIAttributes.MEDIA_IS_FULLSCREEN)))
      return (i2 = this.mediaController) == null || i2.dispatchEvent(new k3.CustomEvent(MediaUIEvents.MEDIA_ENTER_FULLSCREEN_REQUEST, { composed: true, bubbles: true })), new Promise((r13, n2) => {
        var d4;
  ...
  async exitFullscreen() {
    var e;
    if (!(!this.mediaController || !this.mediaController.hasAttribute(MediaUIAttributes.MEDIA_IS_FULLSCREEN)))
      return (e = this.mediaController) == null || e.dispatchEvent(new k3.CustomEvent(MediaUIEvents.MEDIA_EXIT_FULLSCREEN_REQUEST, { composed: true, bubbles: true })), new Promise((i2, r13) => {
        var n2;
  ...
  get poster() {
    ...
    if (this.playbackId && !this.audio)
      return st3(this.playbackId, { customDomain: this.customDomain, thumbnailTime: (r13 = this.thumbnailTime) != null ? r13 : this.startTime, programTime: this.programStartTime, token: i2.thumbnail });
  }
  set poster(e) {
  ...
  get storyboard() {
    ...
    if (!(this.audio || !this.playbackId || !this.streamType || [h.LIVE, h.UNKNOWN].includes(this.streamType) || e.playback && !e.storyboard))
      return dt3(this.playbackId, { customDomain: this.customDomain, token: e.storyboard, programStartTime: this.programStartTime, programEndTime: this.programEndTime });
  }
  get audio() {
  ...
  get primaryColor() {
    ...
    if (e != null || this.mediaTheme && (e = (r13 = (i2 = k3.getComputedStyle(this.mediaTheme)) == null ? void 0 : i2.getPropertyValue("--_primary-color")) == null ? void 0 : r13.trim(), e))
      return e;
  }
  set primaryColor(e) {
  ...
  get secondaryColor() {
    ...
    if (e != null || this.mediaTheme && (e = (r13 = (i2 = k3.getComputedStyle(this.mediaTheme)) == null ? void 0 : i2.getPropertyValue("--_secondary-color")) == null ? void 0 : r13.trim(), e))
      return e;
  }
  ...
  get accentColor() {
    ...
    if (e != null || this.mediaTheme && (e = (r13 = (i2 = k3.getComputedStyle(this.mediaTheme)) == null ? void 0 : i2.getPropertyValue("--_accent-color")) == null ? void 0 : r13.trim(), e))
      return e;
  }
  set accentColor(e) {
  ...
  get playbackRates() {
    if (this.hasAttribute(o2.PLAYBACK_RATES))
      return this.getAttribute(o2.PLAYBACK_RATES).trim().split(/\s*,?\s+/).map((e) => Number(e)).filter((e) => !Number.isNaN(e)).sort((e, i2) => e - i2);
  }
  set playbackRates(e) {
    if (!e) {
...
J3 = /* @__PURE__ */ new WeakMap(), ee3 = /* @__PURE__ */ new WeakMap(), te3 = /* @__PURE__ */ new WeakMap(), P3 = /* @__PURE__ */ new WeakMap(), ae2 = /* @__PURE__ */ new WeakMap(), K3 = /* @__PURE__ */ new WeakMap(), m3 = /* @__PURE__ */ new WeakSet(), I3 = function() {
  ...
  if (!u3(this, ee3)) {
    ...
    try {
      if (customElements.upgrade(this.mediaTheme), !(this.mediaTheme instanceof k3.HTMLElement))
        throw "";
    } catch {
  ...
  let e = (r13) => {
    var l3, b6;
    if (!(r13 != null && r13.startsWith("theme-")))
      return;
  ...
  new MutationObserver((r13) => {
    for (let { attributeName: n2 } of r13)
      e(n2);
  ...
  this.addEventListener("error", e), this.media && (this.media.errorTranslator = (i2 = {}) => {
    var n2, d4, l3;
    if (!(((n2 = this.media) == null ? void 0 : n2.error) instanceof T))
      return i2;
  ...
  let i2, r13 = /* @__PURE__ */ new WeakMap(), n2 = () => this.streamType === h.LIVE && !this.secondaryColor && this.offsetWidth >= 800, d4 = (_2, A3, R2 = false) => {
    ...
    Array.from(_2 && _2.activeCues || []).forEach((h4) => {
      if (!(!h4.snapToLines || h4.line < -5 || h4.line >= 0 && h4.line < 10))
        if (!A3 || this.paused) {
...
var ue3 = (e, t4) => {
  if (Object.is(e, t4))
    return true;
  if (typeof e != "object" || e === null || typeof t4 != "object" || t4 === null)
    return false;
  if (Array.isArray(e))
    return !Array.isArray(t4) || e.length !== t4.length ? false : e.some((a3, l3) => t4[l3] === a3);
  let n2 = Object.keys(e), o4 = Object.keys(t4);
  if (n2.length !== o4.length)
    return false;
  for (let a3 = 0; a3 < n2.length; a3++)
    if (!oe4.call(t4, n2[a3]) || !Object.is(e[n2[a3]], t4[n2[a3]]))
      return false;
  return true;
};
...
mux-embed/dist/mux.mjs:
  ...
  *)
*/
//# sourceMappingURL=dist-4ZOE3DYP.js.map
